...
public class BbsApp {
	...
	public static void main(String[] args) {
		...
		while(run) {
			System.out.println("----------------------------------------------------------------");
			System.out.println("1.글쓰기 | 2.조회 | 3.수정 | 4.삭제 | 5.상세조회 | 6.종료 ");
			System.out.println("----------------------------------------------------------------");
			System.out.print(">");
	...
	private static int login() {
		...
		datebase.MemberDAO mDao = new datebase.MemberDAO();
		datebase.MemberDTO mDto = mDao.searchById(memberId);
